...
function elegant_pink_change_comment_form_default_fields( $fields ){    
    ...
    $fields['author'] = '<p class="comment-form-author"><input id="author" name="author" placeholder="' . esc_attr__( 'Name*', 'elegant-pink' ) . '" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>';
    
    $fields['email'] = '<p class="comment-form-email"><input id="email" name="email" placeholder="' . esc_attr__( 'Email*', 'elegant-pink' ) . '" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';
    
    $fields['url'] = '<p class="comment-form-url"><input id="url" name="url" placeholder="' . esc_attr__( 'Website', 'elegant-pink' ) . '" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></p>'; 
...
function elegant_pink_change_comment_form_defaults( $defaults ){    
    $defaults['comment_field'] = '<p class="comment-form-comment"><textarea id="comment" name="comment" placeholder="' . esc_attr__( 'Comment*', 'elegant-pink' ) . '" cols="45" rows="8" aria-required="true"></textarea></p>';
...
function elegant_pink_footer_credit(){
    ...
    $text .= '</span>';
    $text .= '<span>';
    $text .= '<a href="' . esc_url( 'http://raratheme.com/wordpress-themes/elegant-pink/' ) .'" rel="nofollow noopener" target="_blank">' . esc_html__( 'Elegant Pink by: Rara Theme', 'elegant-pink' ) .'</a>';
    $text .= '</span><span>';
    $text .= sprintf( esc_html__( 'Powered by: %s', 'elegant-pink' ), '<a href="'. esc_url( __( 'https://wordpress.org/', 'elegant-pink' ) ) .'" target="_blank" rel="nofollow noopener">WordPress</a>' );
    $text .= '</span>';
