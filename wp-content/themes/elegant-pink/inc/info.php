...
function elegant_pink_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'elegant-pink' ) . ': </label><a href="' . esc_url( 'http://raratheme.com/previews/?theme=elegant-pink' ) . '" target="_blank" rel="nofollow noopener">' . __( 'here', 'elegant-pink' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View documentation', 'elegant-pink' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/documentation/elegant-pink/' ) . '" target="_blank" rel="nofollow noopener">' . __( 'here', 'elegant-pink' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme info', 'elegant-pink' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/elegant-pink/' ) . '" target="_blank" rel="nofollow noopener">' . __( 'here', 'elegant-pink' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support ticket', 'elegant-pink' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/support-ticket/' ) . '" target="_blank" rel="nofollow noopener">' . __( 'here', 'elegant-pink' ) . '</a></span><br />';
	...
	$theme_info .= '<span class="sticky_info_row"><label class="more-detail row-element">' . __( 'More WordPress Themes', 'elegant-pink' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/' ) . '" target="_blank" rel="nofollow noopener">' . __( 'here', 'elegant-pink' ) . '</a></span><br />';
