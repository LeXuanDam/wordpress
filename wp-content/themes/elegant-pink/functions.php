...
function elegant_pink_scripts() {
    ...
    wp_register_script( 'elegant-pink-custom-js', get_template_directory_uri() . '/js' . $build . '/custom' . $suffix . '.js', array('jquery'), $version, true );
	wp_register_script( 'elegant-pink-ajax', get_template_directory_uri() . '/js' . $build . '/ajax' . $suffix . '.js', array('jquery'), $version, true );
